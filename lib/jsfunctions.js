...
//-----------------------------------------------------------------------------
		//function onVisibiltyChangedRedGreen() 
		//is the handler for getSessionUser 
		//
//-----------------------------------------------------------------------------
function onloadendRedGreen(event) {
//	var foundUPN=fromjson.getFeaturesByAttribute('upn', '609-0616-0276');
	alert("ekke loadend");//+foundUPN.length);
} 
// end of function onVisibiltyChangedRedGreen

function onVisibiltyChangedRedGreen(event) {
	var foundUPN=fromjson.getFeaturesByAttribute('upn', '609-0616-0276');
	alert("ekke visibility "+foundUPN.length+" "+foundUPN[0].upn);
} 
// end of function onVisibiltyChangedRedGreen
