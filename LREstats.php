	...
	<!--the following districtname is set in jsfunctions.js in function sessionuserhandler-->
		...
		<tr>
			...
			<td>
				...
				<table style="border:0px" cellpadding="10" cellspacing="5" align='center'>
				<tr>
					<td width="10px" style="border:0px">Expected:</td>
					<td width="25px" style="border:0px; float: right; text-align: right">
			...
			<td>
				...
				<tr>
					<td width="10px" style="border:0px">Expected:</td>
					<td width="25px" style="border:0px; width:50%; text-align: right">
