...
$st = $pdo->prepare("SELECT * from `rev_bibiani`.`payments_property` d1 where d1.`payment` <0 AND d1.upn IN (select upn from `revenue`.`kml_from_LUPMIS` where `districtid` = 126); ");
if (!$st->execute()){
