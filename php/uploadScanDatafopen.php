...
// startForm arguments: action, method, id, optional attributes added in associative array
		$frmStr = $frm->startForm('readScanData.php', 'post', 'demoForm',
    ...
    "<table class='formTbl'><tr><td>" .
	   ...
	   // wrap form elements in paragraphs 
		...
		// using html5 required attribute
		$frm->addInput('radio', 'ifproperty', '1', array('id'=>'ifproperty', 'checked'=>'1')  ) . ' Property Data ' . PHP_EOL .
		$frm->addInput('radio', 'ifproperty', '0', array('checked'=>'0')) . ' Business Data' . 
